...
■このフォークの解説  
  ・xtne6fさんが新ニコニコ実況に対応させたものをさらに手を加えて非公式コミュニティの実況も使えるように改造しました。  
  ・投稿時点で（大丈夫だとは思いますが）、放送開始・終了時の動作が確認できていないです。すみません。（確認でき次第消します）  
  ・VS2019でビルドされています  
  ・非公式実況コミュニティは初期状態で無効になっているためiniの[ChatStreams]にあるものを必要に応じてコメントを外すようにしてください  
  ・Releaseにあるものはiniに書き込まれているされた非公式コミュニティの記載が古い可能性があるので注意してください  
  ・最新のものはソース内のiniにあります（時々更新するかもしれません）  
  ・あとはオリジナルに準拠します  
 ■謝辞  
  もとの改造を施したxtne6fさんに感謝。
